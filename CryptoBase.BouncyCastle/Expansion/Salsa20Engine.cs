...
namespace CryptoBase.BouncyCastle.Expansion
{
	...
	internal class Salsa20Engine : IStreamCipher
	{
		...
		protected virtual void SetKey(byte[]? keyBytes, byte[] ivBytes)
		{
			if (keyBytes != null)
			{
				if (keyBytes.Length is not 16 and not 32)
				{
		...
		internal static void SalsaCore(int rounds, uint[] input, uint[] x)
		{
			...
			{
				x04 ^= (x00 + x12).RotateLeft(7);
				x08 ^= (x04 + x00).RotateLeft(9);
				x12 ^= (x08 + x04).RotateLeft(13);
				x00 ^= (x12 + x08).RotateLeft(18);
				x09 ^= (x05 + x01).RotateLeft(7);
				x13 ^= (x09 + x05).RotateLeft(9);
				x01 ^= (x13 + x09).RotateLeft(13);
				x05 ^= (x01 + x13).RotateLeft(18);
				x14 ^= (x10 + x06).RotateLeft(7);
				x02 ^= (x14 + x10).RotateLeft(9);
				x06 ^= (x02 + x14).RotateLeft(13);
				x10 ^= (x06 + x02).RotateLeft(18);
				x03 ^= (x15 + x11).RotateLeft(7);
				x07 ^= (x03 + x15).RotateLeft(9);
				x11 ^= (x07 + x03).RotateLeft(13);
				x15 ^= (x11 + x07).RotateLeft(18);

				x01 ^= (x00 + x03).RotateLeft(7);
				x02 ^= (x01 + x00).RotateLeft(9);
				x03 ^= (x02 + x01).RotateLeft(13);
				x00 ^= (x03 + x02).RotateLeft(18);
				x06 ^= (x05 + x04).RotateLeft(7);
				x07 ^= (x06 + x05).RotateLeft(9);
				x04 ^= (x07 + x06).RotateLeft(13);
				x05 ^= (x04 + x07).RotateLeft(18);
				x11 ^= (x10 + x09).RotateLeft(7);
				x08 ^= (x11 + x10).RotateLeft(9);
				x09 ^= (x08 + x11).RotateLeft(13);
				x10 ^= (x09 + x08).RotateLeft(18);
				x12 ^= (x15 + x14).RotateLeft(7);
				x13 ^= (x12 + x15).RotateLeft(9);
				x14 ^= (x13 + x12).RotateLeft(13);
				x15 ^= (x14 + x13).RotateLeft(18);
			}
