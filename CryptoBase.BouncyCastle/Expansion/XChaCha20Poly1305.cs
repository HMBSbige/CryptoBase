...
public sealed class XChaCha20Poly1305 : IAeadCipher
{
	...
	public int GetOutputSize(int len)
	{
		...
		return mState switch
		{
			State.DecInit or State.DecAad or State.DecData => Math.Max(0, total - MacSize),
			State.EncInit or State.EncAad or State.EncData => total + MacSize,
	...
	private static ulong IncrementCount(ulong count, uint increment, ulong limit)
	{
