...
public class GcmCryptoModeBlock16X86 : IAEADCrypto
{
		...
		Span<byte> destination, ReadOnlySpan<byte> associatedData = default)
	{
		...
		Span<byte> counter0 = counterBlock.Slice(12 + 0 * 16, 4);
		Span<byte> counter1 = counterBlock.Slice(12 + 1 * 16, 4);
		Span<byte> counter2 = counterBlock.Slice(12 + 2 * 16, 4);
		Span<byte> counter3 = counterBlock.Slice(12 + 3 * 16, 4);
		Span<byte> counter4 = counterBlock.Slice(12 + 4 * 16, 4);
		Span<byte> counter5 = counterBlock.Slice(12 + 5 * 16, 4);
		Span<byte> counter6 = counterBlock.Slice(12 + 6 * 16, 4);
		Span<byte> counter7 = counterBlock.Slice(12 + 7 * 16, 4);
		Span<byte> counter8 = counterBlock.Slice(12 + 8 * 16, 4);
		Span<byte> counter9 = counterBlock.Slice(12 + 9 * 16, 4);
		Span<byte> counter10 = counterBlock.Slice(12 + 10 * 16, 4);
		Span<byte> counter11 = counterBlock.Slice(12 + 11 * 16, 4);
		Span<byte> counter12 = counterBlock.Slice(12 + 12 * 16, 4);
		Span<byte> counter13 = counterBlock.Slice(12 + 13 * 16, 4);
		Span<byte> counter14 = counterBlock.Slice(12 + 14 * 16, 4);
		Span<byte> counter15 = counterBlock.Slice(12 + 15 * 16, 4);

		nonce.CopyTo(counterBlock);
		nonce.CopyTo(counterBlock[(1 * 16)..]);
		nonce.CopyTo(counterBlock[(2 * 16)..]);
		nonce.CopyTo(counterBlock[(3 * 16)..]);
		nonce.CopyTo(counterBlock[(4 * 16)..]);
		nonce.CopyTo(counterBlock[(5 * 16)..]);
		nonce.CopyTo(counterBlock[(6 * 16)..]);
		nonce.CopyTo(counterBlock[(7 * 16)..]);
		nonce.CopyTo(counterBlock[(8 * 16)..]);
		nonce.CopyTo(counterBlock[(9 * 16)..]);
		nonce.CopyTo(counterBlock[(10 * 16)..]);
		nonce.CopyTo(counterBlock[(11 * 16)..]);
		nonce.CopyTo(counterBlock[(12 * 16)..]);
		nonce.CopyTo(counterBlock[(13 * 16)..]);
		nonce.CopyTo(counterBlock[(14 * 16)..]);
		nonce.CopyTo(counterBlock[(15 * 16)..]);
