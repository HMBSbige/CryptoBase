...
public class SM4CTRTest
{
	...
	private static void T(IStreamCrypto crypto, ReadOnlySpan<byte> source, ReadOnlySpan<byte> expected)
	{
		Assert.Equal(@"SM4-CTR", crypto.Name);

		Span<byte> destination = new byte[source.Length + 1];
