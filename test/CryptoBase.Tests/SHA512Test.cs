...
{
	private static void SHA512DigestTest_Internal(IHash sha512, string str, string sha512Str)
	{
		Assert.Equal(@"SHA-512", sha512.Name);
		Assert.Equal(64, sha512.Length);
		Assert.Equal(128, sha512.BlockSize);
		...
		Assert.Equal(sha512Str, hash.ToHex());
	...
	[InlineData(@"abcdbcdecdefdefgefghfghighijhi", @"6b22632a618b07bc6f18072e60648086a0c3f4220724f737f322606cbacee8ea510dc2970735072ca8e59f185f3a770a8948beb95dfe3bbbe18572ae6ec91f20")]
	[InlineData(@"jkijkljklmklmnlmnomnopnopq", @"f02d8e6b2649207bbfa0ca8fa9a667fc7673f9d23821ae59ac25c3939db9766b301cb61d0b6f56664d3b225b966dedfbf62281f4da7ebda8f13a2e2470a21a76")]
	[InlineData(@"01234567012345670123456701234567", @"f8c0085901bb2e5fc290921c7b08cf9c2e4c305ca417bd18d37fc8e6d5b08c05acedbce6a92c4bc3098c324bf1930ab76aa1dbb3336129006d991ffc8d4a9d09")]
	public void SHA512DigestTest(string str, string expected)
	{
		SHA512DigestTest_Internal(new DefaultSHA512Digest(), str, expected);
		SHA512DigestTest_Internal(new BcSHA512Digest(), str, expected);
	}
	...
	/// </summary>
	[Theory]
	[InlineData(@"a", 1000000, @"e718483d0ce769644e2e42c7bc15b4638e1f98b13b2044285632a803afa973ebde0ff244877ea60a4cb0432ce577c31beb009c5c2c49aa2e4eadb217ad8cc09b")]
	[InlineData(@"abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmno", 16777216, @"b47c933421ea2db149ad6e10fce6c7f93d0752380180ffd7f4629a712134831d77be6091b819ed352c2967a2e2d4fa5050723c9630691f1a05a7281dbe6c1086")]
