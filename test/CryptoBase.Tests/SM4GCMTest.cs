...
public class SM4GCMTest
{
	...
	{
		await crypto.AEADTest(@"SM4-GCM", nonceHex, associatedDataHex, tagHex, plainHex, cipherHex);
	}
	...
	public async Task Test(string keyHex, string nonceHex, string associatedDataHex, string tagHex, string plainHex, string cipherHex)
	{
		...
		await Test_Internal(AEADCryptoCreate.Sm4Gcm(key), nonceHex, associatedDataHex, tagHex, plainHex, cipherHex);
	}
}
