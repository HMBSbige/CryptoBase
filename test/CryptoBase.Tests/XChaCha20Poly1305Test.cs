...
public class XChaCha20Poly1305Test
{
	...
	{
		Assert.Equal(@"XChaCha20-Poly1305", crypto.Name);
	...
	/// </summary>
	[Theory]
	[InlineData(@"808182838485868788898A8B8C8D8E8F909192939495969798999A9B9C9D9E9F", @"404142434445464748494a4b4c4d4e4f5051525354555657", @"50515253C0C1C2C3C4C5C6C7",
