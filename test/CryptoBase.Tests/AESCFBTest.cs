...
public class AESCFBTest
{
	...
	{
		Assert.Equal(@"AES-CFB", crypto.Name);
	...
	/// </summary>
	[Theory]
	[InlineData(@"A0B0C0D0E0F1011121314151617181AA", @"fe3577795961e1fbbbb82528c74d2e99",
	...
	[InlineData(@"08090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F", @"00112233445566778899aabbccddeeff",
