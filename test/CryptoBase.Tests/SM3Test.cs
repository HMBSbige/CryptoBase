...
{
	private static void SM3DigestTest_Internal(IHash sm3, string str, string sm3Str)
	{
		Assert.Equal(@"SM3", sm3.Name);
		Assert.Equal(32, sm3.Length);
		...
		Assert.Equal(sm3Str, hash.ToHex());
	...
	[InlineData(@"abcde", @"afe4ccac5ab7d52bcae36373676215368baf52d3905e1fecbe369cc120e97628")]
	[InlineData(@"abcdez", @"897671415764167c85037e3bba4cc0f8fa019accd94730f0188b5c74bc502912")]
	[InlineData(@"d60e1c2860a249ddb96ddfebbb618a53daa635b1c504409c935ffab4", @"ab00404a6acb46f48ee28b42354ce984adb2e19b11a4675a5a043f62506fe117")]
	[InlineData(@"d60e1c2860a249ddb96ddfebbb618a53daa635b1c504409c935ffab41a0d", @"2b9bdd2ffbe3f293744af51b181cdb36a6bf0d5065306a56a7b8c5a5cb2e03d1")]
	...
	[InlineData(@"1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890", @"f07b76f62b616de94e6ef9733db1953b8e3fa55014c3f4667abf2ea60aa44250")]
	public void SM3DigestTest(string str, string sm3Str)
	{
		SM3DigestTest_Internal(new BcSM3Digest(), str, sm3Str);
