...
public class HmacTest
{
	...
	public async Task TestSm3(string keyStr, string messageHex, string expected)
	{
		...
		await Assert.That(hmac.Name).IsEqualTo(@"HMAC-SM3");
		await TestUtils.MacTest(hmac, messageHex.FromHex(), expected);
	}
	...
	public async Task TestMd5(string keyStr, string messageHex, string expected)
	{
		...
		await Assert.That(hmac.Name).IsEqualTo(@"HMAC-MD5");
		await TestUtils.MacTest(hmac, messageHex.FromHex(), expected);
	}
	...
	public async Task TestSha1(string keyStr, string messageHex, string expected)
	{
		...
		await Assert.That(hmac.Name).IsEqualTo(@"HMAC-SHA-1");
		await TestUtils.MacTest(hmac, messageHex.FromHex(), expected);
	}
	...
	[Arguments(@"0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c", @"546573742057697468205472756e636174696f6e", @"0e2aea68a90c8d37c988bcdb9fca6fa8099cd857c7ec4a1815cac54c")]
	...
	{
		Skip.Test("Not Impl SHA-224");
		using IMac hmac = HmacUtils.Create(DigestType.Sha224, keyStr.FromHex());
		await Assert.That(hmac.Name).IsEqualTo(@"HMAC-SHA-224");
		await TestUtils.MacTest(hmac, messageHex.FromHex(), expected);
	}
	...
	public async Task TestSha256(string keyStr, string messageHex, string expected)
	{
		...
		await Assert.That(hmac.Name).IsEqualTo(@"HMAC-SHA-256");
		await TestUtils.MacTest(hmac, messageHex.FromHex(), expected);
	}
	...
	public async Task TestSha384(string keyStr, string messageHex, string expected)
	{
		...
		await Assert.That(hmac.Name).IsEqualTo(@"HMAC-SHA-384");
		await TestUtils.MacTest(hmac, messageHex.FromHex(), expected);
	}
	...
	public async Task TestSha512(string keyStr, string messageHex, string expected)
	{
		...
		await Assert.That(hmac.Name).IsEqualTo(@"HMAC-SHA-512");
		await TestUtils.MacTest(hmac, messageHex.FromHex(), expected);
	}
}
