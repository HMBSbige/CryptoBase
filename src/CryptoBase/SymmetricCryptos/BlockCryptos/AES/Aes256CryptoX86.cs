...
public class Aes256CryptoX86 : AesCrypto
{
	...
	public override VectorBuffer16 Encrypt(scoped in VectorBuffer16 source)
	{
		...
		t.V128 = AesX86.Encrypt(t.V128, _k12);
		t.V128 = AesX86.Encrypt(t.V128, _k13);
		t.V128 = AesX86.EncryptLast(t.V128, _k14);
	...
	public override VectorBuffer16 Decrypt(scoped in VectorBuffer16 source)
	{
		...
		t.V128 = AesX86.Decrypt(t.V128, _k24);
		t.V128 = AesX86.Decrypt(t.V128, _k25);
		t.V128 = AesX86.Decrypt(t.V128, _k26);
		t.V128 = AesX86.Decrypt(t.V128, _k27);
