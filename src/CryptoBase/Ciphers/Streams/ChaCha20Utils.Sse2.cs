...
internal static partial class ChaCha20Utils
{
	...
	{
		ref Vector128<uint> stateRef = ref state.As<uint, Vector128<uint>>();
		ref byte streamRef = ref stream.GetReference();

		ref readonly Vector128<uint> s0 = ref stateRef;
		ref readonly Vector128<uint> s1 = ref Unsafe.Add(ref stateRef, 1);
		ref readonly Vector128<uint> s2 = ref Unsafe.Add(ref stateRef, 2);
		ref readonly Vector128<uint> s3 = ref Unsafe.Add(ref stateRef, 3);
	...
	{
		ref Vector128<uint> x0 = ref state.As<uint, Vector128<uint>>();
		ref Vector128<uint> x1 = ref Unsafe.Add(ref x0, 1);
		ref Vector128<uint> x2 = ref Unsafe.Add(ref x0, 2);
		ref Vector128<uint> x3 = ref Unsafe.Add(ref x0, 3);
	...
	{
		ref Vector128<uint> stateRef = ref state.As<uint, Vector128<uint>>();
		ref Vector128<byte> sourceRef = ref source.As<byte, Vector128<byte>>();
		...
		ref readonly Vector128<uint> s2 = ref Unsafe.Add(ref stateRef, 2);
		ref readonly Vector128<uint> s3 = ref Unsafe.Add(ref stateRef, 3);
		ref readonly Vector128<byte> src0 = ref sourceRef;
		ref readonly Vector128<byte> src1 = ref Unsafe.Add(ref sourceRef, 1);
		ref readonly Vector128<byte> src2 = ref Unsafe.Add(ref sourceRef, 2);
		ref readonly Vector128<byte> src3 = ref Unsafe.Add(ref sourceRef, 3);
	...
	{
		Vector128<uint> incCounter = Vector128.Create(0u, 1, 2, 3);
		int length = source.Length;
		int offset = 0;
		...
		while (length >= 256)
		{
			...
			Vector128<uint> x12 = incCounter + Vector128.Create(counter);
			Vector128<uint> o12 = x12;
	...
	{
		ref Vector128<byte> s0 = ref source.As<Vector128<byte>>();
		ref Vector128<byte> s1 = ref Unsafe.Add(ref s0, 4);
		ref Vector128<byte> s2 = ref Unsafe.Add(ref s0, 8);
		ref Vector128<byte> s3 = ref Unsafe.Add(ref s0, 12);
