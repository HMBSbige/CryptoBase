...
internal static partial class Salsa20Utils
{
	...
	public static void UpdateKeyStream(Span<uint> state, Span<byte> stream, byte rounds)
	{
		...
		ref Vector128<uint> stateVectors = ref state.As<uint, Vector128<uint>>();
		ref readonly Vector128<uint> s0 = ref stateVectors;
		ref readonly Vector128<uint> s1 = ref Unsafe.Add(ref stateVectors, 1);
		ref readonly Vector128<uint> s2 = ref Unsafe.Add(ref stateVectors, 2);
		ref readonly Vector128<uint> s3 = ref Unsafe.Add(ref stateVectors, 3);
