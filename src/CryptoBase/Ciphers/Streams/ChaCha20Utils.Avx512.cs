...
internal static partial class ChaCha20Utils
{
	...
	public static int ChaChaCoreOriginalSoa1024Avx512(byte rounds, Span<uint> state, ReadOnlySpan<byte> source, Span<byte> destination)
	{
		...
		Vector512<byte> o8 = Vector512.Create(Unsafe.Add(ref stateRef, 8)).AsByte();
		Vector512<byte> o9 = Vector512.Create(Unsafe.Add(ref stateRef, 9)).AsByte();
		...
		while (length >= 1024)
		{
			...
			AddAndTranspose(counter, out Vector512<byte> o12, out Vector512<byte> o13);
	...
	public static int ChaChaCoreOriginalSoa2048Avx512(byte rounds, Span<uint> state, ReadOnlySpan<byte> source, Span<byte> destination)
	{
		...
		while (length >= 2048)
		{
			...
			AddAndTranspose(counter, out Vector512<byte> o12, out Vector512<byte> o13);
			Vector512<uint> t12 = o12.AsUInt32();
			Vector512<uint> t13 = o13.AsUInt32();
			...
			AddAndTranspose(counter + 16, out o12, out o13);
			...
			for (int i = 0; i < rounds; i += 2)
			{
				QuarterRound(ref x00, ref x04, ref x08, ref x012);
				QuarterRound(ref x01, ref x05, ref x09, ref x013);
				QuarterRound(ref x02, ref x06, ref x010, ref x014);
				QuarterRound(ref x03, ref x07, ref x011, ref x015);

				QuarterRound(ref x10, ref x14, ref x18, ref x112);
				QuarterRound(ref x11, ref x15, ref x19, ref x113);
				QuarterRound(ref x12, ref x16, ref x110, ref x114);
				QuarterRound(ref x13, ref x17, ref x111, ref x115);

				QuarterRound(ref x00, ref x05, ref x010, ref x015);
				QuarterRound(ref x01, ref x06, ref x011, ref x012);
				QuarterRound(ref x02, ref x07, ref x08, ref x013);
				QuarterRound(ref x03, ref x04, ref x09, ref x014);

				QuarterRound(ref x10, ref x15, ref x110, ref x115);
				QuarterRound(ref x11, ref x16, ref x111, ref x112);
				QuarterRound(ref x12, ref x17, ref x18, ref x113);
				QuarterRound(ref x13, ref x14, ref x19, ref x114);
			}
			...
			x08 = (x08.AsUInt32() + o8.AsUInt32()).AsByte();
			x18 = (x18.AsUInt32() + o8.AsUInt32()).AsByte();
			x09 = (x09.AsUInt32() + o9.AsUInt32()).AsByte();
			...
			x012 = (x012.AsUInt32() + t12).AsByte();
			x112 = (x112.AsUInt32() + o12.AsUInt32()).AsByte();
			x013 = (x013.AsUInt32() + t13).AsByte();
	...
	public static int ChaChaCoreSoa1024Avx512(byte rounds, Span<uint> state, ReadOnlySpan<byte> source, Span<byte> destination)
	{
		...
		while (length >= 1024)
		{
			...
			Vector512<byte> o12 = Vector512.CreateSequence(counter, 1u).AsByte();
			Vector512<byte> x0 = o0;
			Vector512<byte> x1 = o1;
			Vector512<byte> x2 = o2;
			Vector512<byte> x3 = o3;
	...
	public static int ChaChaCoreSoa2048Avx512(byte rounds, Span<uint> state, ReadOnlySpan<byte> source, Span<byte> destination)
	{
		...
		while (length >= 2048)
		{
			...
			Vector512<byte> o12;
			Vector512<byte> t12 = o12 = Vector512.CreateSequence(counter, 1u).AsByte();
			Vector512<byte> x00 = o0;
			Vector512<byte> x01 = o1;
			Vector512<byte> x02 = o2;
			Vector512<byte> x03 = o3;
			...
			Vector512<byte> x014 = o14;
			Vector512<byte> x015 = o15;
			o12 = Vector512.CreateSequence(counter + 16, 1u).AsByte();
			Vector512<byte> x10 = o0;
			Vector512<byte> x11 = o1;
			Vector512<byte> x12 = o2;
			Vector512<byte> x13 = o3;
			...
			x011 = (x011.AsUInt32() + o11.AsUInt32()).AsByte();
			x111 = (x111.AsUInt32() + o11.AsUInt32()).AsByte();
			x012 = (x012.AsUInt32() + t12.AsUInt32()).AsByte();
			x112 = (x112.AsUInt32() + o12.AsUInt32()).AsByte();
