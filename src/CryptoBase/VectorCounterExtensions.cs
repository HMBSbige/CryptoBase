...
internal static class VectorCounterExtensions
{
	...
	public static Vector128<T> IncUInt128Le<T>(this Vector128<T> nonce)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector128<T> IncUInt32Le<T>(this Vector128<T> nonce)
	{
		return (nonce.AsUInt32() + Vector128.Create(1u, 0, 0, 0)).As<uint, T>();
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector256<T> AddUInt128Le22<T>(this Vector256<T> nonce)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector256<T> AddUInt32Le22<T>(this Vector256<T> nonce)
	{
	...
	/// </summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector256<T> AddUInt128Le01<T>(this Vector256<T> nonce)
	{
		Vector256<long> v = nonce.AsInt64();
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector256<T> AddUInt32Le01<T>(this Vector256<T> nonce)
	{
	...
	/// </summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector512<T> AddUInt128Le4444<T>(this Vector512<T> nonce)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector512<T> AddUInt32Le4444<T>(this Vector512<T> nonce)
	{
	...
	/// </summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector512<T> AddUInt128Le0123<T>(this Vector512<T> nonce)
	{
		Vector512<ulong> v = nonce.AsUInt64();
		Vector512<ulong> thr = Vector512.Create
		(
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector512<T> AddUInt32Le0123<T>(this Vector512<T> nonce)
	{
